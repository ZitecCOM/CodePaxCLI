 ...
 * */
define('PROJECT_NAME', 'CodePax Test Project');

/**
 * Defines the versioning system : SVN/GIT
 * */
define('VERSIONING', 'GIT');
 ...
 * */
define('REPO_URL', 'https://github.com/IulianCristianGrigoritaZitec/CodePaxTestProject.git');
 ...
 * "features/" for GIT
 * */
define('SCM_BRANCH_PREFIX', "features/");
 ...
 * */
define('PROJECT_DIR', 'C:\Program Files\WAMP\www\CodePaxTestProject' . DIRECTORY_SEPARATOR);
 ...
 * */
define('PATH_TO_SQL_BIN', 'C:\WINDOWS\system32\cmd.exe /c "C:\Program Files\WAMP\bin\mysql\mysql5.6.17\bin\mysql.exe"');
 ...
 * for cmd.exe i.e. 'C:\WINDOWS\system32\cmd.exe /c '
 * */
define('PATH_TO_SQL_DUMP_BIN', 'C:\WINDOWS\system32\cmd.exe /c "C:\Program Files\WAMP\bin\mysql\mysql5.6.17\bin\mysqldump.exe"');
 ...
 * DB name
 * */
define('DB_NAME', 'codepaxtestproject');
